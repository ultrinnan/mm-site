...
function _share($key)
{
	...
	$sharelinks = (object)array(
		...
		'google' => 'https://plus.google.com/share?url=' . $e_url,
...
<div class="social_share_box">
    <div class="hex solid">
        <a class="social linkedin" href="<?= _share('linkedin');?>" target="_blank"></a>
    </div>
    <div class="hex solid">
        <a class="social facebook" href="<?= _share('facebook');?>" target="_blank"></a>
    </div>
    <div class="hex solid">
